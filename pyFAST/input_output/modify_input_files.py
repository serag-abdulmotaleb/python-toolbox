...
def modify_fst_deck(fst_dir,fst_file,out_dir='.',suffix='',cond_suffix='',dof_suffix='',
    ...
    fst_out = os.path.join(out_dir,fst_root + suffix + dof_suffix + cond_suffix + '.fst')
    ...
    if hydro_dict:
        hd = fstin(hydro_base)
        hydro_out = fst_root + '_HydroDyn' + suffix + cond_suffix + '.dat'
    ...
    if inflow_dict:
        inflow_out = fst_root + '_Inflow' + suffix + cond_suffix + '.dat'
